...
export default function ProcessPage() {
  return (
    <main className="mx-auto w-full max-w-[820px] px-6 pb-32 pt-16 sm:px-8 sm:pt-24">
      <Hero />
      <Thoughts />
      <Problems />
      <Decisions />
...
function Decisions() {
  return (
    <Section title="Key decisions">
      <ol className="mt-2 flex flex-col gap-7 list-decimal pl-5 marker:text-[14px] marker:font-semibold marker:text-foreground/40">
        {DECISIONS.map((d, i) => (
          <li key={i} className="pl-1">
            <h3 className="text-[15px] font-semibold tracking-tight text-foreground">
              {d.title}
            </h3>
            <div className="mt-2 flex flex-col gap-2 text-[14px] leading-relaxed text-muted-foreground [&_code]:rounded [&_code]:bg-muted [&_code]:px-1 [&_code]:py-0.5 [&_code]:text-[12.5px] [&_code]:font-medium [&_code]:text-foreground">
              {d.body}
            </div>
          </li>
        ))}
...
function ScreenFrame({
  ...
  return (
    <figure className="flex flex-col gap-3">
      ...
      <figcaption className="mx-auto max-w-[680px] px-2 text-center text-[13px] leading-relaxed text-muted-foreground">
        {caption}
      </figcaption>
    </figure>
  );
...
function Assumptions() {
  return (
    <Section title="Assumptions">
      ...
      <ol className="mt-5 flex flex-col gap-6 list-decimal pl-5 marker:text-[14px] marker:font-semibold marker:text-foreground/40">
        <li className="pl-1">
          <h3 className="text-[15px] font-semibold tracking-tight text-foreground">
            One team per user.
          </h3>
          <div className="mt-2 flex flex-col gap-2 text-[14px] leading-relaxed text-muted-foreground">
            <p>
              ...
              <code className="rounded bg-muted px-1 py-0.5 text-[12.5px] font-medium text-foreground">
...
function Prose({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex max-w-[720px] flex-col gap-3 text-[14.5px] leading-[1.65] text-foreground/80">
      {children}
    </div>
  );
}
