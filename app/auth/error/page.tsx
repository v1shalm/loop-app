      ...
      <div className="w-full max-w-[440px]">
        ...
        <div className="overflow-hidden rounded-xl border border-border/60 bg-card shadow-soft-sm">
          <div className="px-7 py-7 text-center">
            ...
            <Link
              href="/login"
              className="focus-ring surface-brand surface-brand-hover mt-5 inline-flex h-10 items-center justify-center rounded-md px-4 text-[13px] font-semibold text-primary-foreground shadow-[var(--shadow-cta)] transition-transform duration-150 ease-[var(--ease-out)] active:scale-[0.985]"
            >
              Try again
            </Link>
          </div>
