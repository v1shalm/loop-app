      ...
      {items.map((k) => {
        ...
        return (
          <button
            ...
            aria-pressed={active}
            className={cn(
              "chip-3d focus-ring flex items-center gap-1.5 rounded-sm border px-3 py-1.5 text-[12.5px] transition-[background-color,color,border-color,transform] duration-150 ease-[var(--ease-out)] active:scale-[0.97] disabled:opacity-60",
              active
