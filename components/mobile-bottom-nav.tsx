...
function TabLink({
  ...
  return (
    <Link
      ...
      className={cn(
        "relative flex flex-1 flex-col items-center justify-center gap-0.5 pb-2.5 pt-2 text-[10px] font-medium transition-[color,transform] duration-150 ease-[var(--ease-out)] active:scale-[0.94] active:bg-accent/30",
